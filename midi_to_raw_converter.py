...
# Usage
midi_file_path = 'hungarindancestevenritchie.mid'
ai_format = midi_to_ai_format(midi_file_path)
print("Formatted data:", ai_format)
output_midi_path = midi_file_path.replace('.mid', '_reconstructed.mid')
ai_format_to_midi(ai_format, output_midi_path)
#write to file
with open('pitch_classes.json', 'w') as file:
  file.write(json.dumps(ai_format))
