...
def build_lstm_model(input_shape):
    ...
    model = Sequential([
        ...
        Dropout(0.2),
        LSTM(32),
        Dense(12, activation='sigmoid')  # 12 outputs as in your original code
    ])
...
if __name__ == '__main__':
    ...
    model_save_path = 'models/lstm_pure_harmony_model.keras'
    ...
    # 2. Split file paths into train/val sets
    ...
    # 6. Build model
    #    We assume your per-step feature vector matches the 'input_shape' you use here.
    #    If each step is 12 features, input_shape should be (seq_length, 12).
    #    Adjust as necessary to match your actual data.
    ...
    # 9. Example: load one file from validation set for a quick example prediction
    if val_files:
